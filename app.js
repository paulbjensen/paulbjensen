...
(function() {
  ...
  setCurrentPostAndPosts = function(cb) {
    return fs.readdir("./posts", function(err, posts) {
      global.posts = posts.reverse();
      return fs.readFile("./posts/" + posts[0], 'utf8', function(err, post) {
  ...
  setCurrentPostAndPosts(function() {
    ...
    app.get('/posts/:year/:month/:day/:name', function(req, res) {
      return fs.exists("./posts/" + req.params.year + "_" + req.params.month + "_" + req.params.day + "_" + req.params.name + ".md", function(exists) {
        if (exists) {
          return fs.readFile("./posts/" + req.params.year + "_" + req.params.month + "_" + req.params.day + "_" + req.params.name + ".md", 'utf8', function(err, post) {
            post = md(post);
            return res.render('index', {
              layout: false,
              locals: {
